...
export class ConnectWiseCpq implements INodeType {
  description: INodeTypeDescription = {
    ...
    properties: [
      ...
      {
        displayName: 'Add filters to narrow results. Each row is: field → operator → value. Rows are joined by the combinator below. For reference fields, type field/subfield (e.g. manufacturer/name) as an expression in the Field box.',
        name: 'filterNotice',
        type: 'notice',
      ...
      },
      {
        ...
        displayOptions: { show: { operation: ['getAll'] } },
        default: {},
        description: 'Filter rows joined by the combinator above',
        options: [
          {
            name: 'conditions',
            displayName: 'Filter',
            values: [
              ...
              },
              {
                ...
                options: [
                  ...
                  { name: 'Date (YYYY-MM-DD)', value: 'datetime' },
              ...
              },
              {
                ...
                type: 'string',
                default: '',
                description: 'Value to compare against. For In / Not In, enter comma-separated values (e.g. Acme,Globex). Booleans: true or false. Datetimes: date only — YYYY-MM-DD (e.g. 2026-02-03); time components are ignored.',
              },
            ],
          },
        ],
